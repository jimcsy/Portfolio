...
import resumePdf from '../assets/Cuasay-resume.pdf';
...
export default function Hero() {
  ...
  onClick={() => {
    ...
    link.href = resumePdf; 
    link.download = 'Genesis_Cuasay_Resume.pdf'; // This is the professional name it will save as on the user's device!
    link.click();
  }}
>
  ...
  Resume
        ...
        <div className="social-links">
          ...
          <a href="https://www.linkedin.com/in/genesis-cuasay" target="_blank" rel="noopener noreferrer">LinkedIn</a>
          <a href="https://www.facebook.com/genisisjim.cuasay/" target="_blank" rel="noopener noreferrer">Facebook</a>
        </div>
      </div>
